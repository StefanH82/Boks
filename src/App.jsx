...
export default function App() {
  ...
  return (
    <div style={{minHeight:"100vh",background:DARK,fontFamily:"'Inter',system-ui,sans-serif",color:"#e8f0eb",position:"relative",overflowX:"hidden"}}>
      ...
      {/* Side images */}
      {isWideScreen && (
        <div style={{position:"fixed",left:0,top:"50%",transform:"translateY(-50%)",width:220,height:500,zIndex:5,pointerEvents:"none",overflow:"hidden"}}>
          <img src="/Left.jpg" alt="" style={{width:"100%",height:"100%",objectFit:"cover",opacity:0.85}}/>
        </div>
      )}
      {isWideScreen && (
        <div style={{position:"fixed",right:0,top:"50%",transform:"translateY(-50%)",width:220,height:500,zIndex:5,pointerEvents:"none",overflow:"hidden"}}>
          <img src="/image-4202271-1.png" alt="" style={{width:"100%",height:"100%",objectFit:"cover",opacity:0.85}}/>
        </div>
      )}
        ...
        <div style={{maxWidth:800,margin:"0 auto"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"14px 0 10px"}}>
            <div style={{display:"flex",alignItems:"center",gap:12}}>
              <div style={{width:42,height:42,borderRadius:10,background:`linear-gradient(135deg,${GREEN},#1a5c34)`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,boxShadow:`0 0 20px ${GREEN}60`}}><img src="/South_Africa_national_rugby_union_team.svg" alt="Springboks" style={{width:"100%",height:"100%",objectFit:"cover"}}/></div>
              <div>
