        ...
        <div style={{maxWidth:800,margin:"0 auto"}}>
          <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"14px 0 10px"}}>
            <div style={{display:"flex",alignItems:"center",gap:12}}>
              <div style={{width:42,height:42,borderRadius:10,background:`linear-gradient(135deg,${GREEN},#1a5c34)`,display:"flex",alignItems:"center",justifyContent:"center",fontSize:22,boxShadow:`0 0 20px ${GREEN}60`}}><img src="/springboks-logo.png" alt="Springboks" style={{width:"100%",height:"100%",objectFit:"cover"}}/></div>
              <div>
